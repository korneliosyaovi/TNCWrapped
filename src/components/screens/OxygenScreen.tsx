...
export default function OxygenScreen({ onNext, onBack }: ScreenProps) {
  ...
  useEffect(() => {
    trackEvent({
      ...
      params: { screen_name: "oxygen", id: userData.identity},
    });
  }, [trackEvent]);
  ...
  const handleAnswer = (attended: boolean) => {
    ...
    setEventAttendance("oxygen", attended);
